<?php  include($_SERVER['DOCUMENT_ROOT']."/CloMaT_ProiectTW/Not_here/php_code_culori.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div id="container">
        ...
        <div id="user">
            ...
            <form method="post" action="http://localhost/CloMaT_ProiectTW/Not_here/php_code_culori.php" >
                ...
                <table>
                    ...
                    <?php while ($row = oci_fetch_array($stid, OCI_ASSOC)) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="http://localhost/CloMaT_ProiectTW/match_culori.php?edit=<?php echo $row['ID']; ?>" class="edit_btn" >Edit</a>
                            </td>
                            <td>
                                <a href="http://localhost/CloMaT_ProiectTW/Not_here/php_code_culori.php?del=<?php echo $row['ID']; ?>" class="del_btn">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
