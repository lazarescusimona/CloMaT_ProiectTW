...
<?php
        ...
        if( $rows1 > 0 )
        {
            header("Location: http://localhost/CloMaT_ProiectTW/new-account.php?account=usernameExistent"); // eroarea account=usernameExistent va fi preluata in new-account.php
            exit();
        }
        ...
        if( $rows2 > 0 )
        {
            ...
            header("Location: http://localhost/CloMaT_ProiectTW/new-account.php?account=emailExistent"); // eroarea account=emailExistent va fi preluata in new-account.php
            exit();
        }
        ...
        {
            $ok1 = 0;
            header("Location: http://localhost/CloMaT_ProiectTW/new-account.php?account=paroleDiferite"); // eroarea account=paroleDiferite va fi preluata in new-account.php
            exit();
        }
        ...
        if($sex != 'Female' && $sex != 'Male' && $sex != 'Other'  )
        {
            ...
            header("Location: http://localhost/CloMaT_ProiectTW/new-account.php?account=sex"); // eroarea account=sex va fi preluata in new-account.php
            exit();
        }
        ...
        if(strlen($parola)<8)
        {
            $ok2 = 0;
            echo "sexul introdus nu este ca in specificatii ";
            header("Location: http://localhost/CloMaT_ProiectTW/new-account.php?account=parolascurta"); // eroarea account=parola va fi preluata in new-account.php
            exit();
        }
        ...
        if ( ctype_digit($data[0]) && ctype_digit($data[1]) &&
             ctype_digit($data[2]) && ctype_digit($data[3]) && $data[4] == '/')
             {
                    ...
                    if ($an > $anAcutual)
                    {
                        header("Location: http://localhost/CloMaT_ProiectTW/new-account.php?account=formatdata"); // eroarea account=formatdata va fi preluata in new-account.php
                        exit();
                    }
        ...
        //header("Location: http://localhost/CloMaT_ProiectTW/new-account.php?account=succes"); //  account=succes va fi preluata in new-account.php
        session_start();
        /*
        ...
        header("location: http://localhost/CloMaT_ProiectTW/thankyou.php");
        exit();
        }
    }
