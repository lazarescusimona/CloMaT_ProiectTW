...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="http://localhost/CloMaT_ProiectTW/css/profile2.css">
...
<body>
   ...
   <div class="portfoliocard" style="z-index: 1;">
      ...
      <div class="left_col">
         ...
         <div class="following">
            <button onclick='window.location.href="http://localhost/CloMaT_ProiectTW/Not_here/deconectare.php";'>Logout</button>
         </div>
         <div class="following">
            <?php require_once ($_SERVER['DOCUMENT_ROOT']."/CloMaT_ProiectTW/Not_here/addRuda.php"); ?>
            <?php
            global $conn;
               ...
               <table class="table">
                  ...
                  ?>
                     <tr>
                        ...
                        <td>
                           <a href="http://localhost/CloMaT_ProiectTW/Not_here/deleteRuda.php?delete=<?php echo $row[1]; ?>" style="background-color:DodgerBlue;padding:5px 10px;font-size:13px;"> Delete </a>
                        </td>
                     </tr>
                  <?php endwhile; ?>
               </table>
