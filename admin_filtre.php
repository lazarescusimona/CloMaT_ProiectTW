<?php  include($_SERVER['DOCUMENT_ROOT']."/CloMaT_ProiectTW/Not_here/php_code_filtre.php");
...
<body>
    <div id="container">
        ...
        <div id="user">
            ...
            <form method="post" action="http://localhost/CloMaT_ProiectTW/Not_here/php_code_filtre.php" >
                ...
                <table>
                    ...
                    <?php while ($row = oci_fetch_array($stid, OCI_ASSOC)) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="http://localhost/CloMaT_ProiectTW/admin_filtre.php?edit=<?php echo $row['ID']; ?>" class="edit_btn" >Edit</a>
                            </td>
                            <td>
                                <a href="http://localhost/CloMaT_ProiectTW/Not_here/php_code_filtre.php?del=<?php echo $row['ID']; ?>" class="del_btn">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
